...
namespace Tests\Klehm\SyliusBrevoMailerPlugin\Unit\Mailer;

use Klehm\SyliusBrevoMailerPlugin\Api\BrevoApiClientInterface;
use Klehm\SyliusBrevoMailerPlugin\Mailer\BrevoMailer;
...
final class BrevoMailerTest extends TestCase
{
    public function testSendWithTemplateId(): void
    {
        ...
        $mailer = new BrevoMailer($templateIdProvider, $apiClient, $dispatcher);
    ...
    public function testFormatRecipients(): void
    {
        ...
        $this->assertContains(['name' => '', 'email' => 'foo@example.com'], $result);
    }
